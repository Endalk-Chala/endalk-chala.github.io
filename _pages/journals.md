...
var journals = [
  ...
  {name:"Political Communication", publisher:"Taylor & Francis", area:"Political Communication", url:"https://www.tandfonline.com/journals/upcp20", access:"Hybrid / Open Select", scope:"Research at the intersection of communication, politics, public opinion, campaigns, and media."},
...
function renderJournals() {
  ...
  var filtered = journals.filter(function(j) {
    var haystack = (j.name + ' ' + j.publisher + ' ' + j.area + ' ' + j.scope + ' ' + (j.access || '')).toLowerCase();
  ...
  for (var i = 0; i < filtered.length; i++) {
    ...
    html += '<div style="font-size:13px;color:#666;margin-bottom:7px;">' + j.publisher + ' &middot; ' + j.area + (j.access ? ' &middot; ' + j.access : '') + '</div>';
